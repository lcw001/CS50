...
bool is_tie(int min)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
//.......................updates candidates not eliminated with min votes   `
        if (candidates[i].votes == min && candidates[i].eliminated == false)
        {
            minvote++;
            noteliminated++;
        }
//........................updates number of candidates not eliminated
...
//if noteliminated = minvote then there is a tie
    if (noteliminated == minvote)
    {
        printf("tie\n");
        return true;
    }
